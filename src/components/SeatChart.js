...
const SeatChart = ({ occasion, tokenMaster, provider, account, setToggle }) => {
  ...
  const buyHandler = async (_seat) => {
    ...
    const connectedTokenMaster = tokenMaster.connect(signer);

    const transaction = await connectedTokenMaster.mint(occasion.id, _seat, { value: occasion.cost });
